        ...
        return (
            <>
                <Paper style={{ padding: 25, marginBottom: 25 }}>
                    <Typography variant="h4" style={{ fontWeight: 100 }} gutterBottom>
                        Guest Information
                    </Typography>
                    <Grid container spacing={2}>
                        <Grid item xs={12} md={3}>
                            ...
                            <Typography variant="subtitle1" style={{ fontWeight: 300, paddingLeft: 25 }}>
                                {values.honorifics}
                            </Typography>
                        </Grid>
                        <Grid item xs={12} md={3}>
                ...
                <Paper style={{ padding: 25 }}>
                    ...
                    <Grid container spacing={2} style={{ paddingTop: 25, paddingBottom: 25 }}>
                        <Grid container justify="space-around" style={{}}>
                            ...
                            >
                                <Typography variant="h5" style={{ fontWeight: 300 }} component="span">
                                    Check-in Date
                                </Typography>
                                <Typography variant="subtitle1" style={{ fontWeight: 300 }} component="span">
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "flex-start" }}>
                        {values.selectedRooms.map((room, i) => {
                            return (
                                <Paper style={{ padding: 10, margin: 5, minWidth: 200 }}>
                                    <div>
