...
export default function ConfirmDialog(props) {
    const onClickConfirm = () => props.onConfirmReset();
    ...
    return (
            <Dialog open={props.open} onClose={props.handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">Are you sure you want to reset your choosen rooms?</DialogContentText>
                </DialogContent>
                <DialogActions>
