							...
							<Grid container spacing={2}>
								...
								<Grid item xs={12} md={6}>
									<TextField
										...
										variant="outlined"
										label="Number of Children  (must below 12 years old)"
								...
								<Grid item xs={12} md={6}>
									<TextField
										...
										onChange={handleChange}
										onBlur={handleBlur}
										helperText={(validateCalled || touched.additional_beds) && errors.additional_beds ? errors.additional_beds : ""}
										error={(validateCalled || touched.additional_beds) && errors.additional_beds ? true : false}
										type="number"
									/>
								</Grid>
								{/* <Grid item xs={12} md={6}>
								...
								<Grid item xs={12} md={6}>
									...
									>
										<Paper style={{ padding: "20px", backgroundColor: "#efefef", textAlign: "justify", marginBottom: "20px" }}>
											<Typography style={{ fontSize: "16px", fontWeight: 700 }}>Reservation Policies</Typography>
											<br></br>
											<Typography style={{ fontSize: "14px", fontWeight: 400 }}>
												<FiberManualRecordIcon style={{ fontSize: "small" }} />
												Take a picture of your Cash Padala or bank deposit and send to Facebook messenger (Maria Paz Bacareza)
											</Typography>
											<Typography style={{ fontSize: "14px", fontWeight: 400 }}>
												<FiberManualRecordIcon style={{ fontSize: "small" }} />
												You must pay for your advance payment through bank deposit or you may send the payment through Cash Padala. If
												you cannot pay for your advanced payment two (2) days before your check-in date, your booking will be cancelled
												or mark no-show .
											</Typography>
											<Typography style={{ fontSize: "14px", fontWeight: 400 }}>
												<FiberManualRecordIcon style={{ fontSize: "small" }} />
