              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onBlur={handleBlur}
                    helperText={
                      (validateCalled || touched.additional_beds) && errors.additional_beds ? errors.additional_beds : ""
                    }
                ...
                <Grid item xs={12} md={6}>
                  ...
                  >
                    <Paper
                      style={{ padding: "20px", backgroundColor: "#efefef", textAlign: "justify", marginBottom: "20px" }}
                    >
