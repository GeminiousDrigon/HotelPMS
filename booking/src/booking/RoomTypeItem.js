      ...
      return (
        ...
        >
          <Paper
            style={{
              padding: 20,
              backgroundColor: selectedType.id === roomType.id ? "#3f51b5" : "#c89553",
              color: selectedType.id === roomType.id && "white"
            }}
          >
            <Typography variant="h5" component="span" gutterBottom style={{ fontWeight: 500, color: "white" }}>
              {roomType.name}
            </Typography>
            <div>
              <Typography
      ...
      return (
        ...
        >
          <Paper
            style={{
              padding: 20,
              backgroundColor: selectedType.id === roomType.id ? "#f9a600" : "white",
              color: selectedType.id === roomType.id && "white"
            }}
          >
            ...
            <div>
              ...
              <Typography
                ...
                color="error"
              >
                <i> Only {roomType.availableRooms} room(s) left! </i>
              </Typography>
            </div>
          </Paper>
        </div>
